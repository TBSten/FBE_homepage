...
export default function Header() {
    ...
    const [stickClasses,stickClassesChange,stickClassName] = useClasses([styles.stick]);
    const ref = useRef<HTMLElement | null>(null);
    const [isMenuOpen,setIsMenuOpen,handleOpenMenu,handleCloseMenu] = useBoolState(false);
    useScroll(()=>{
        if(ref.current){
